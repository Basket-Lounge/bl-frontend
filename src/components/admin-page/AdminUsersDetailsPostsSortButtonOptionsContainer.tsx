...
const AdminUsersDetailsPostsSortButtonOptionsContainer = () => {
  ...
  const teamsIndex = sort.findIndex((value) => value === 'team__symbol' || value === '-team__symbol');
  ...
  const [teamsSort, setTeamsSort] = useState<boolean | null>(
    teamsIndex !== -1 ? (sort[teamsIndex] === 'team__symbol' ? true : false) : null
  );
...
export default AdminUsersDetailsPostsSortButtonOptionsContainer;