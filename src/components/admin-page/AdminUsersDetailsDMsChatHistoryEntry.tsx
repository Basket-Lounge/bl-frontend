...
interface IAdminUsersDetailsDMsChatHistoryEntryProps {
  message: UserChatMessageWithUserData
}

const AdminUsersDetailsDMsChatHistoryEntry = ({ message }: IAdminUsersDetailsDMsChatHistoryEntryProps) => {
...
export default AdminUsersDetailsDMsChatHistoryEntry;