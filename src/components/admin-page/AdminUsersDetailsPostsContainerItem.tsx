...
import AdminUsersDetailsPostsContainerOptions from "./AdminUsersDetailsPostsContainerItemOptions";


interface IAdminUsersDetailsPostsContainerItemProps {
  post: TeamPost;
}

const AdminUsersDetailsPostsContainerItem = ({ post }: IAdminUsersDetailsPostsContainerItemProps) => {
  ...
  return (
    <div className="bg-color3 rounded-md p-[24px] flex gap-[24px] items-start">
      ...
      <AdminUsersDetailsPostsContainerOptions post={post} />
    </div>
  );
}

export default AdminUsersDetailsPostsContainerItem;