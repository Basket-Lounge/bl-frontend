...
const GameSummaryGeneralInfo : React.FC<IGameSummaryGeneralInfoProps> = ({
  ...
  return (
    <div className="flex flex-col gap-[16px] item-stretch">
      <h3 className="text-white text-[16px] lg:text-[20px] font-bold">경기 정보</h3>
      <div className="p-[24px] flex flex-col gap-[24px] items-stretch rounded-md bg-color3 text-[14px] lg:text-[16px]">
